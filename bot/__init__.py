...
# ============================ REQUIRED ================================
if not (BOT_TOKEN := environ.get('BOT_TOKEN', '7399216007:AAFY0NYffBmMAEUI9hXWdBIUS314vb6CO1c')):
    LOGGER.error('BOT_TOKEN variable is missing! Exiting now')
    exit(1)

bot_id = BOT_TOKEN.split(':', 1)[0]

if DATABASE_URL := environ.get('DATABASE_URL', 'mongodb+srv://leech1234:leech1234@cluster0.zdk7l8p.mongodb.net/?retryWrites=true&w=majority'):
    ...
    try:
        ...
        conn.close()
        BOT_TOKEN = environ.get('BOT_TOKEN', '7399216007:AAFY0NYffBmMAEUI9hXWdBIUS314vb6CO1c')
        bot_id = BOT_TOKEN.split(':', 1)[0]
        if DATABASE_URL := environ.get('DATABASE_URL', 'mongodb+srv://leech1234:leech1234@cluster0.zdk7l8p.mongodb.net/?retryWrites=true&w=majority'):
            if not DATABASE_URL.startswith('mongodb'):
                try:
...
if TELEGRAM_API := environ.get('TELEGRAM_API', '20967142'):
    TELEGRAM_API = int(TELEGRAM_API)
else:
    LOGGER.error('TELEGRAM_API variable is missing! Exiting now')
    exit(1)

if not (TELEGRAM_HASH := environ.get('TELEGRAM_HASH', '94e4f21b715fed8857cdf8d065c30cce')):
...
TORRENT_TIMEOUT = environ.get('TORRENT_TIMEOUT', '300')
...
DATABASE_URL = environ.get('DATABASE_URL', 'mongodb+srv://leech1234:leech1234@cluster0.zdk7l8p.mongodb.net/?retryWrites=true&w=majority')
...
LEECH_LOG = environ.get('LEECH_LOG', '-1002034652382')
if LEECH_LOG:
