...
async def start(client: Client, message: Message):
    buttons = ButtonMaker()
    buttons.button_link('Owner', f'https://t.me/MrSagar0')
    buttons.button_link('Channel', f'https://t.me/MrSagarBots')
...
async def restart(_, message: Message):
    ...
    if hrestart:
        ...
        _, msg = await gather(kill_route(), sendMessage('<i>Restarting bro wait if I did not respond from 2-3 min tag my broken 💔 baby @MrSagarBots...</i>', message))
